...
if [[ "$ATYPE" == "PE" || "$ATYPE" == "RPE" ]]; then
        ...
        cd-hit-est -i uniq.F.fasta -o xxx -c $3 -T 0 -M 0 -g 1 -d 100 &>cdhit.log
...
for ((P = $1; P <= $2; P++))
        ...
        cp reference.fasta reference.c.0.80.K1.$P.K2.$i.fasta
        echo $P $i 0.80 $SEQS >> kopt.data
                ...
                cp reference.fasta reference.c.$j.K1.$P.K2.$i.fasta
